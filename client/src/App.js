...
import { Welcome, SignUp, NoPage, SignIn, Home, SignOut, Profile, SignOutSuccess, CreatePost, MyPosts } from 'pages';
      ...
      // App after login
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path='createpost' element={<CreatePost cookies={cookies} serverUrl={serverUrl}/>} />
